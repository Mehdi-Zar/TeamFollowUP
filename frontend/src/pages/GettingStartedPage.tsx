  ...
  fr: {
    admin: {
      ...
      steps: [
        ...
        { icon: "admin", title: "Activez les services", desc: "Choisissez les modules visibles (Fil, Reporting…) et leurs options dans l'onglet Services.", to: "/admin", cta: "Administration → Services" },
        ...
        { icon: "dash", title: "Pilotez l'ensemble", desc: "Suivez l'avancement de toutes les tribes sur le tableau de bord.", to: "/", cta: "Voir le dashboard" },
      ],
    },
    tribe_leader: {
      ...
      steps: [
        ...
        { icon: "squads", title: "OTD (objectifs engagés de l'année)", desc: "Pour chaque squad : fixez les OTD (objectifs engagés de l'année).", to: "/mes-squads", cta: "Mes squads → Éditer" },
  ...
  en: {
    admin: {
      ...
      steps: [
        ...
        { icon: "admin", title: "Enable services", desc: "Pick which modules are visible (Feed, Reporting…) and their options.", to: "/admin", cta: "Admin → Services" },
        { icon: "mail", title: "Configure email (SMTP)", desc: "Required for automatic reports and notifications.", to: "/admin", cta: "Admin → Email" },
        { icon: "dash", title: "Steer everything", desc: "Track all tribes on the dashboard.", to: "/", cta: "Open dashboard" },
      ],
    },
    tribe_leader: {
      ...
      steps: [
        ...
        { icon: "squads", title: "OTD (this year's committed objectives)", desc: "Per squad: set the OTD (this year's committed objectives).", to: "/mes-squads", cta: "My squads → Edit" },
