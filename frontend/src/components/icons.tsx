// Petites icônes SVG inline (stroke = currentColor). Pas de dépendance externe.
...
export function IconTribes(p: IconProps) {
  return (
    <Svg {...p}>
      <circle cx="9" cy="8" r="3" />
      <path d="M3 20c0-3 3-5 6-5s6 2 6 5" />
      <path d="M16 5.5a3 3 0 0 1 0 5M18 20c0-2-1-3.5-2.5-4.5" />
    </Svg>
  );
}

export function IconEntry(p: IconProps) {
  return (
    <Svg {...p}>
      <path d="M12 20h9" />
