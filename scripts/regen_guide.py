...
PAGES = [
    ...
    ("/", "Tableau de bord",
     ...
     "plateformes et l'onglet Initiatives liste les engagements de la tribu.",
    ...
    ("/saisie", "Reporting (saisie)",
     "L'ecran ou un responsable met sa squad a jour, etape par etape : ses "
     "engagements OTD, les jalons qui les rendent concrets, leur statut, les "
     "messages cles, le moral de l'equipe, puis la soumission du cycle. Un bandeau "
     "rappelle quelle squad et quelle semaine on remplit, et la barre d'etapes dit "
     "ce qui est deja renseigne. L'avancement en pourcentage ne se saisit pas : il "
     "se calcule a partir des jalons termines.", ".step-rail"),
    ("/organigramme", "Organigramme",
     "L'organisation de la tribu, en liste ou en arbre, avec ses squads et leurs "
     "equipes. Les tribus se choisissent dans la barre du haut de l'ecran, avec "
    ...
    ("/squads/{squad}", "Detail d'une squad",
     "Tout ce qu'une squad porte : ses initiatives, ses engagements OTD avec leur "
     "date et leur statut, sa roadmap par trimestre, ses messages cles, les actions "
     "decidees en comite, son budget, son equipe et l'historique de ses "
     "soumissions. Exportable en HTML, image et PowerPoint.", ".otd-tbl, .card"),
    ("/mes-squads", "Mes squads",
     "Gerer ses squads : identite et responsables, ce qu'elles suivent (KPI, "
     "budget, plateformes steerco, initiatives portees), leurs engagements OTD et "
     "leur budget. Un squad leader y gere son equipe.", ".card"),
    ("/acces", "Acces",
    ...
    ("/admin", "Administration",
     ...
     "installation : l'organisation (tribus, squads, plateformes, comptes, "
    ...
    ("/preferences", "Preferences",
     "Vos reglages personnels : langue, notifications, mot de passe.", ".card"),
    ("/fil", "Tweet zone (fil d'actualite)",
     "Le fil interne de la tribu : publier une information, un incident ou un "
...
<body>
  ...
  <main>
    ...
    (membre, squad leader, tribe leader, admin) et des services actifs : le fil et
