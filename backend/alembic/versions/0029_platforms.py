...
A platform is served by one or more squads (one platform may be fed by two squads
or more), and the steering committee wants one slide per platform, not one per
