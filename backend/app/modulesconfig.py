...
def _defaults() -> dict:
    ...
    return {
        ...
        # Plus d'interrupteur "objectives": les objectifs de squad ont quitte le
        # produit, l'OTD est le seul engagement. Une valeur encore stockee est ignoree.
        "squad_content": {"enabled": True, "roadmap": True, "kpis": False,
...
def get_modules(db: Session) -> dict:
    ...
    return cached(db, "get_modules", _get_modules_uncached)


def _get_modules_uncached(db: Session) -> dict:
