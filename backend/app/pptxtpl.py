...
# Un deck se lit projete au fond d'une salle, pas a 40 cm d'un ecran, et les corps
# d'origine y passaient trop petits. Un facteur unique les agrandit, partage par les
# trois renderers et applique au seul endroit ou un nombre devient une taille de
# police. Les geometries qui se deduisent d'un corps (hauteur de ligne, caracteres
# par ligne, largeur d'une pastille) passent par le meme facteur: sinon le texte
# grossirait dans des boites restees a l'ancienne mesure, et deborderait. La ou une
# mise en page choisit son corps en descendant une echelle jusqu'a ce que tout
# tienne (la frise, les cartes par trimestre), elle part de plus haut et retombe
# d'elle-meme sur l'ancien corps quand la place manque: agrandir ne fait donc pas
