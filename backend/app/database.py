...
# Every write is checked against its columns (lengths, blank names, years): see
# writeguard. Installed here so that every session, tests included, carries it.
from . import writeguard  # noqa: E402

writeguard.install()

from . import configcache  # noqa: E402
